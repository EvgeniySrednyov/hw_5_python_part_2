...
def print_readable_name_and_args(func, **kwargs):
    func_name = func.__name__.replace("_", " ").title()
    args_str = ", ".join([f"{key}={value}" for key, value in kwargs.items()])
    print(f'"{func_name} [{args_str}]"')

def test_readable_function():
    print_readable_name_and_args(open_browser, browser_name="Chrome")
    print_readable_name_and_args(go_to_companyname_homepage, page_url="https://companyname.com")
    print_readable_name_and_args(find_registration_button_on_login_page, page_url="https://companyname.com/login", button_text="Register")
